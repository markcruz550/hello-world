	...
	$(document).ready(function() {
		...
		$("#form1").validate({
			...
			messages: {
				...
				account: {
					required: "Please choose account Name",
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					$gump->filter_rules(array(
						'account'     => 'trim|sanitize_string|mysql_escape',
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
			...
			if($db->query("insert into stock_details(account,stock_id,stock_name,stock_quatity,supplier_id,company_price,selling_price,category) values('$account','$stockid','$name',0,'$supplier',$cost,$sell,'$category')"))
			{ 
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
                  ...
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  ?>
 					  ...
 					  <td><span class="man">*</span>ACCOUNT TYPE:</td>
                      <td><select name="account" type="text" id="accoutn" readonly="readonly" maxlength="200"  class="round default-width-input" value="<?php echo $autoid; ?>" />
                      <option ></option>
	                  <option value='ALFAMART'>ALFAMART</option>
	                  <option value='EVER'>EVER</option>
	                  <option value='ROBINSON'>ROBINSON</option>
	                  <option value='ROBINSON-C'>ROBINSON-C</option>
					  <option value='ROBINSON-P'>ROBINSON-P</option>
					  <option value='SMCO'>SMCO</OPTION>
					  <OPTION VALUE='SSM'>SSM</OPTION>
					  <OPTION VALUE='SVI'>SVI</OPTION>
					  <OPTION VALUE='WALTERMART'>WALTERMART</OPTION></td></tr>
                    </select>
	...
	<div id="footer">
		...
		<p>KRAMYAR &copy;Copyright 2013</p>
