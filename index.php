...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="http://bountyfarms.com/" id="company-branding" class="fr"  target="blank"><img src="<?php if(isset($_SESSION['logo'])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/1.png"; } ?>" alt="Point of Sale" /></a>
			
		</div> <!-- end full-width -->	

	</div> <!-- end header -->
	
        <h1 style="margin-left: 440px; font-family: Georgia;     font-weight: bold; font-size:20px; color: #0060BF"><center>BOUNTY FARMS INC.</center> &nbsp;&nbsp;&nbsp;</h1>
...
<div>
		<form action="checklogin.php" method="POST" id="login-form" class="cmxform" autocomplete="off">
			...
			<br/>
                ...
                </form></table><div style="margin-left: 400px">
...
<script type="text/javascript">
	...
	<!-- FOOTER -->
	<div id="footer">
<p>KRAMYAR &copy;Copyright 2015</p>
