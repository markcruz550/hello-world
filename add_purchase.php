            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                    	...
                    	<td><span class="man">*</span>Account</td>
                      <td>
                      	<select name="supplier" placeholder="ENTER SUPPLIER" type="text" id="supplier"  maxlength="200"  class="round default-width-input"  style="width:130px " />
                 <option ></option>
					  ...
					  <OPTION VALUE='WALTERMART'>WALTERMART</OPTION> </select>

                  </td></tr><br>
                  <tr>
                      <td><span class="man">*</span>Stores:</td>
